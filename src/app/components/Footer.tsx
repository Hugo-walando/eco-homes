        ...
        <div className='grid grid-cols-1 gap-8 lg:grid-cols-3'>
          <div>
            ...
            <p className='mt-4 max-w-xs text-gray-500'>
              ...
              ensuring your home is uniquely yours.
            </p>
          ...
          <div className='grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4'>
            <div>
              <p className='font-medium text-col_gray_dark'>Home</p>
            ...
            <div>
              <p className='font-medium text-col_gray_dark'>About</p>
            ...
            <div>
              <p className='font-medium text-col_gray_dark'>Services</p>
            ...
            <div>
              <p className='font-medium text-col_gray_dark'>Gallery</p>
